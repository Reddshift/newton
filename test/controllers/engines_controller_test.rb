...
class EnginesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engine" do
    assert_difference('Engine.count') do
      post engines_url, params: { engine: { mass: @engine.mass, max_hp: @engine.max_hp, max_rpm: @engine.max_rpm, max_torque: @engine.max_torque } }
    end
  ...
  test "should update engine" do
    patch engine_url(@engine), params: { engine: { mass: @engine.mass, max_hp: @engine.max_hp, max_rpm: @engine.max_rpm, max_torque: @engine.max_torque } }
